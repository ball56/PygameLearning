...
'PLAYER'
player_x, player_y = int(width / 2), int(height - 50)
player_spd = 5

'ENEMIES'
enemies_x = int(width / 2)
enemy1_y = randint(-height, -car_y)
enemy2_y = randint(-height, -car_y)
enemy3_y = randint(-height, -car_y)
enemies_spd = 0
